namespace CopilotNexus.Shim.Versioning;

/// <summary>
/// Resolved versioned executable entry.
/// Inlined from CopilotNexus.Core to keep the shim dependency-free.
/// </summary>
internal sealed record VersionedExecutable(
    string VersionDirectory,
    string ExecutablePath,
    SemanticVersion Version);

/// <summary>
/// Resolves versioned executable payloads from side-by-side version folders.
/// Inlined from CopilotNexus.Core to keep the shim dependency-free.
/// </summary>
