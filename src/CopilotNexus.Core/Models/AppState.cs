...
/// history persistence — we store lightweight UI metadata and
/// Nexus-generated system messages that are outside SDK history.
/// </summary>
public class TabState
{
    ...
    /// <summary>Additional MCP config file paths merged for this session.</summary>
    public List<string> AdditionalMcpConfigPaths { get; set; } = new();

    /// <summary>Optional list of enabled MCP server names.</summary>
    ...
    /// <summary>
    /// System messages generated by Nexus/app logic (outside SDK session history).
    /// </summary>
    public List<MessageState> NexusSystemMessages { get; set; } = new();
}
